...
class Helper
{
     ...
     */
    public static function removeUnsupportedAttributes(array &$globalAttributes)
    {
        $integrationAttributes = ServiceRegister::getService(Attributes::CLASS_NAME)->getAttributes();
        foreach ($globalAttributes as $attributeName => $formattedGlobalAttribute) {
            if (self::getAttributeByName($integrationAttributes, $attributeName) === null) {
